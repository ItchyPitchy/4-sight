...
const game = new (0, _gameDefault.default)(GAME_WIDTH, GAME_HEIGHT, ctx);
let oldTimeStamp = 0;
...
},{"../Entity/Player1":"5Raoz","../Entity/Wall":"dZG75","./Level":"exWig","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5Raoz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"dZG75":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _entity = require("./Entity");
var _entityDefault = parcelHelpers.interopDefault(_entity);
...
},{"./Entity":"8SMxX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"exWig":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Level {
    constructor(structure){
        ...
        this.systems = [
            new (0, _shootSystem.ShootSystem)(),
    ...
    buildLevel(gameWidth, gameHeight) {
        ...
        this.structure.forEach((row, rowIndex)=>{
            ...
            row.forEach((obstacle, obstacleIndex)=>{
                ...
                const cell = new (0, _cellDefault.default)(position.x, position.y, maximumCellSize, maximumCellSize * position.x, maximumCellSize * position.y);
    ...
    draw(ctx) {
        ...
        for (const row of this.board)for (const cell of row){
            ...
            ctx.beginPath();
            if (cell.entities.find((entity)=>entity instanceof (0, _wallDefault.default))) {
                ctx.fillStyle = "#000";
                ctx.fillRect(drawPosition.x, drawPosition.y, cell.size, cell.size);
                ctx.fill();
            } else if (cell.entities.find((entity)=>entity instanceof (0, _player1.Player1))) {
                ctx.fillStyle = "#543";
                ctx.fillRect(drawPosition.x, drawPosition.y, cell.size, cell.size);
                ctx.fill();
            } else {
...
},{"../Entity/Player1":"5Raoz","../Entity/Wall":"dZG75","../System/MoveSystem":"cuuW5","../System/ShootSystem":"duP3I","./Cell":"zlZpP","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cuuW5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _player1 = require("../Entity/Player1");
var _cell = require("../Level/Cell");
var _cellDefault = parcelHelpers.interopDefault(_cell);
...
class MoveSystem extends (0, _system.System) {
    ...
    appliesTo(entity) {
        return entity instanceof (0, _cellDefault.default);
    }
    update(entities, dt, game) {
        const playerCell = entities.find((cell)=>cell.entities.find((entity)=>entity instanceof (0, _player1.Player1)));
        ...
        if (moveToCell) {
            moveToCell.addEntity(new (0, _player1.Player1)());
            playerCell.entities = playerCell.entities.filter((entity)=>!(entity instanceof (0, _player1.Player1)));
        }
    }
}
exports.default = MoveSystem;

},{"../Entity/Player1":"5Raoz","../Level/Cell":"zlZpP","./System":"1zonU","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"zlZpP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../Entity/Entity":"8SMxX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1zonU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _cell = require("../Level/Cell");
var _cellDefault = parcelHelpers.interopDefault(_cell);
var _bulletSystem = require("./BulletSystem");
var _bulletSystemDefault = parcelHelpers.interopDefault(_bulletSystem);
var _system = require("./System");
class ShootSystem extends (0, _system.System) {
    constructor(){
        ...
        this.bulletSystem = new (0, _bulletSystemDefault.default)();
    ...
    appliesTo(entity) {
        return entity instanceof (0, _cellDefault.default) && Boolean(entity.entities.find((entity)=>entity instanceof (0, _wallDefault.default) || entity instanceof (0, _player1.Player1)));
    }
    update(entities, dt, game) {
        const playerCell = entities.find((cell)=>cell.entities.find((entity)=>entity instanceof (0, _player1.Player1)));
        if (!playerCell) return;
        ...
        const obstacleCells = entities.filter((cell)=>cell.entities.find((entity)=>entity instanceof (0, _wallDefault.default)));
        ...
        if (this.keys.has("leftClick")) {
            this.bulletSystem.addBullets(new (0, _bulletDefault.default)({
                x: this.startPos.x,
                y: this.startPos.y
            }, {
...
},{"../Entity/Bullet":"h611p","../Entity/Player1":"5Raoz","../Entity/Wall":"dZG75","../Level/Cell":"zlZpP","./BulletSystem":"3K1N8","./System":"1zonU","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"h611p":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _entity = require("./Entity");
var _entityDefault = parcelHelpers.interopDefault(_entity);
...
},{"./Entity":"8SMxX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3K1N8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class BulletSystem {
    constructor(){
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fUTXd","jeorp"], "jeorp", "parcelRequire2c60")
